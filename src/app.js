...
function displayTemperature(response) {
  ...
  let description = document.querySelector(".weather-description-today");
  let humidity = document.querySelector("#humidity");
  let wind = document.querySelector("#wind");
  let icon = document.querySelector("#big-weather-icon");
...
function getData(event) {
  event.preventDefault();
  let searchedCity = document.querySelector("#search-input-city").value;
